...
screen navigation():
    ...
    vbox:
        ...
        # textbutton _("CONTINUE") action ShowMenu("about")

        # if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

        #     ## Help isn't necessary or relevant to mobile devices.
        #     textbutton _("OPTIONS") action ShowMenu("help")
...
style navigation_button:
    background None
    hover_background At(
        Frame("gui/button_hover.png", 10, 10, tile=False),
        Transform(alpha=0.4) ## Slightly stretch the hover image and makes it 60% opaque.
    )
    xalign 0.5
    yalign 0.5
...
screen main_menu():
    ...
    add "images/logo.png" xpos 0.5 ypos 0.25 anchor (0.5, 0.5)
